...
7. Execute the following command from command line to convert annotated xml files inside "Annotations" folder 
...
### FEATURES OF THE TRANSFORM.PY:

* The script transform.py converts annotated xml files present in the directory 'var/www/html/LabelMeAnnotationTool/Annotations/example_folder' to PASCAL VOC Format annotated xml files that are present in the directory 'var/www/html/LabelMeAnnotationTool/Annotations'
